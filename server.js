...
app.use('/products',ProductRoute); //app.use() is a powerful mechanism in Express that allows you to add functionality to your application in a modular way by chaining middleware functions together. Middleware functions can be third-party middleware or custom functions that you define.
// app.get('/',(req,res)=>{
//     res.send(`Hello I am G2`);
// })

// app.get('/home',(req,res)=>{
//     res.send(`Hello i am at Home Page`);
// })
...
//         { email: email1 }, // Query to find the user
//         {
//             $set: {
//                 firstName: req.body.firstName,
//                 lastName: req.body.lastName,
